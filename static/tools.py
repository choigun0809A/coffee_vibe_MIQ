    ...
    for doc in docs:
        ...
        for type_of in data.keys():
            ...
            for question, answer in data[type_of].items():
                ...
                yy += 1
            yy += 1
    users_ref = db.collection('Choistests_intelligences')
